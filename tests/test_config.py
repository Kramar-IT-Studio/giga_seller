...
def test_settings_validation_with_valid_tokens():
    ...
    settings = Settings(
        TELEGRAM_TOKEN="правильный_токен", GIGACHAT_TOKEN="правильный_токен"
    )
...
def test_settings_validation_with_empty_telegram_token():
    ...
    settings = Settings(TELEGRAM_TOKEN="", GIGACHAT_TOKEN="правильный_токен")
...
def test_settings_validation_with_empty_gigachat_token():
    ...
    settings = Settings(TELEGRAM_TOKEN="правильный_токен", GIGACHAT_TOKEN="")
